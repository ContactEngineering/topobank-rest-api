...
# filesystem. Without S3 there is no direct upload: `get_upload_instructions`
# points the client at the `upload-direct-local` route instead of at a presigned
# URL, and only the POST method is available.
