...
class StrictFieldMixin:
    ...
    def validate(self, attrs):
        ...
        read_only_fields = {field_name for field_name, field in self.fields.items() if
                            field.read_only} | set(
...
class UserUpdateMixin:
    ...
    def perform_create(self, serializer):
        ...
        OrgModel = get_organization_model()
        owned_by = OrgModel.objects.for_user(
            user).first() if OrgModel else None  # TODO: Limit to one organization per user
