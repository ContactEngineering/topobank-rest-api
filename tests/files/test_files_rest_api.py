...
from topobank.testing.factories import ManifestFactory, ManifestSetFactory
from topobank.testing.mock_auth.authorization.models import (
    PermissionSet,
    UserPermission,
)
...
def test_modify_file(
    ...
    permissions = PermissionSet.objects.create()
    permissions.grant_for_user(user_alice, "view")
    folder2 = ManifestSet.objects.create(permissions=permissions, read_only=read_only2)
