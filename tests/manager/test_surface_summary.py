...
from topobank_rest_api.manager.utils import bandwidths_data
...
def two_topos_mock_for_bandwidth(mocker, db):
    ...
    class STTopoStub:  # ST: from module SurfaceTopography
        ...
        def short_reliability_cutoff(self):
            return 1.2 if self.with_cut_off else None  # should be seen in supplib
    ...
    reverse_patch = mocker.patch('topobank_rest_api.manager.utils.get_api_url')
